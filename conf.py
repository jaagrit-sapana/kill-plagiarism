...
BLOG_AUTHOR = "Kill Plagiarism"  # (translatable)
BLOG_TITLE = "Kill Plagiarism"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jaagrit-sapana.github.io/kill-plagiarism/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
#BASE_URL = "https://killplagiarism.github.io/"
BLOG_EMAIL = "NOT-YET" # TODO: Update email address once created
BLOG_DESCRIPTION = "Learn more about how plagiarism is working in Nepal"  # (translatable)
